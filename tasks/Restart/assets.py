...
class RestartAssets: 
	...
	# 邮件小图标 
	I_HARVEST_MAIL = RuleImage(roi_front=(1145,18,37,25), roi_back=(1145,18,37,25), threshold=0.8, method="Template matching", file="./tasks/Restart/harvest/harvest_harvest_mail.png")
	# 全部收取 
