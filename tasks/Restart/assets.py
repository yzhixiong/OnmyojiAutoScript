...
class RestartAssets: 
	...
	# Image Rule Assets
	# 庭院卷轴打开 
	I_LOGIN_SCROOLL_OPEN = RuleImage(roi_front=(1116,617,20,29), roi_back=(1116,617,20,29), threshold=0.8, method="Template matching", file="./tasks/Restart/login/login_login_scrooll_open.png")
	# 庭院卷轴关闭 
	I_LOGIN_SCROOLL_CLOSE = RuleImage(roi_front=(1111,636,28,39), roi_back=(1111,636,28,39), threshold=0.7, method="Template matching", file="./tasks/Restart/login/login_login_scrooll_close.png")
	# description 
