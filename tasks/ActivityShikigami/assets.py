...
class ActivityShikigamiAssets: 
	...
	# Click Rule Assets
	# description 
	C_RANDOM_LEFT = RuleClick(roi_front=(21,64,203,490), roi_back=(21,64,203,490), name="random_left")
	# description 
	C_RANDOM_RIGHT = RuleClick(roi_front=(1047,55,158,532), roi_back=(1047,55,158,532), name="random_right")
	# description 
	C_RANDOM_TOP = RuleClick(roi_front=(85,46,1153,67), roi_back=(85,46,1153,67), name="random_top")
	# description 
