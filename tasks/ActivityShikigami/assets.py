...
class ActivityShikigamiAssets: 
	...
	# Image Rule Assets
	# 进入活动 
	I_SHI = RuleImage(roi_front=(522,211,21,21), roi_back=(64,115,1110,427), threshold=0.7, method="Template matching", file="./tasks/ActivityShikigami/as/as_shi.png")
	# 左上角返回 
	...
	# 进入爬塔 
	I_BATTLE = RuleImage(roi_front=(459,241,32,133), roi_back=(459,241,32,133), threshold=0.7, method="Template matching", file="./tasks/ActivityShikigami/as/as_battle.png")
	# 归鹿之途 
	...
	# 上锁图标 
	I_LOCK = RuleImage(roi_front=(801,665,24,22), roi_back=(801,665,24,22), threshold=0.8, method="Template matching", file="./tasks/ActivityShikigami/as/as_lock.png")
	# 还未上锁图片 
	I_UNLOCK = RuleImage(roi_front=(806,666,18,21), roi_back=(806,666,18,21), threshold=0.8, method="Template matching", file="./tasks/ActivityShikigami/as/as_unlock.png")
	# 点击战斗 
	I_FIRE = RuleImage(roi_front=(1141,592,64,59), roi_back=(1141,592,64,59), threshold=0.7, method="Template matching", file="./tasks/ActivityShikigami/as/as_fire.png")
	# 体力按钮 
	I_AP = RuleImage(roi_front=(1095,557,23,24), roi_back=(1095,557,23,24), threshold=0.8, method="Template matching", file="./tasks/ActivityShikigami/as/as_ap.png")
	# 活动体力 
	I_AP_ACTIVITY = RuleImage(roi_front=(1136,558,21,27), roi_back=(1136,558,21,27), threshold=0.8, method="Template matching", file="./tasks/ActivityShikigami/as/as_ap_activity.png")
	# 切换按键 
	I_SWITCH = RuleImage(roi_front=(1215,559,23,23), roi_back=(1215,559,23,23), threshold=0.8, method="Template matching", file="./tasks/ActivityShikigami/as/as_switch.png")
	# 购买活动的体力 
	...
	# 活动票数（没有百分比） 
	O_REMAIN_AP_ACTIVITY2 = RuleOcr(roi=(546,18,60,29), area=(546,18,60,29), mode="Digit", method="Default", keyword="", name="remain_ap_activity2")
