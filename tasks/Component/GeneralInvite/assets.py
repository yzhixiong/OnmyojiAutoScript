...
class GeneralInviteAssets: 
	...
	# 悬赏封印点击邀请 
	I_INVITE_ENSURE_WANTED_QUESTS = RuleImage(roi_front=(503,546,132,60), roi_back=(503,546,132,60), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralInvite/gi/gi_invite_ensure_wanted_quests.png")
	# 判断是否点中好友了 
