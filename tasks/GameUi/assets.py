...
class GameUiAssets: 
	...
	# description 
	I_MAIN_GOTO_GUILD = RuleImage(roi_front=(551,621,46,47), roi_back=(551,621,46,47), threshold=0.7, method="Template matching", file="./tasks/GameUi/page/page_main_goto_guild.png")
	# description 
