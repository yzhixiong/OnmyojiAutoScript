...
class GameUiAssets: 
	...
	# 进入商店 
	I_MAIN_GOTO_MALL = RuleImage(roi_front=(663,661,41,22), roi_back=(644,613,81,78), threshold=0.5, method="Template matching", file="./tasks/GameUi/page/page_main_goto_mall.png")
	# 进入阴阳寮 
	I_MAIN_GOTO_GUILD = RuleImage(roi_front=(540,611,50,54), roi_back=(540,611,50,54), threshold=0.5, method="Template matching", file="./tasks/GameUi/page/page_main_goto_guild.png")
	# 进入组队 
